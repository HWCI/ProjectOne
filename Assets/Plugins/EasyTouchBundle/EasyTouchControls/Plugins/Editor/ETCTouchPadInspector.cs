    ...
    public override void OnInspectorGUI()
    {
        ...
        if (t.showBehaviourInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                {
                    t.allowSimulationStandalone = ETCGuiTools.Toggle("Allow simulation on standalone",
                ...
                {
                    ETCAxisInspector.AxisInspector(t.axisX, "Horizontal", ETCBase.ControlType.TouchPad, false,
                        unityAxes);
                }
                ETCGuiTools.EndGroup();
        ...
        if (t.showSpriteInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                t.GetComponent<Image>().sprite = (Sprite) EditorGUILayout.ObjectField("Frame",
