...
public class ETCJoystickInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (t.showPSInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                else if (t.joystickType == ETCJoystick.JoystickType.Dynamic)
                {
                    ...
                    t.allowJoystickOverTouchPad =
                        ETCGuiTools.Toggle("Allow over touchpad", t.allowJoystickOverTouchPad, true);
                    t.joystickArea =
                        (ETCJoystick.JoystickArea) EditorGUILayout.EnumPopup("Joystick area", t.joystickArea);
                    if (t.joystickArea == ETCJoystick.JoystickArea.UserDefined)
                    {
                        t.userArea = (RectTransform) EditorGUILayout.ObjectField("User area", t.userArea,
        ...
        if (t.showAxesInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                ETCGuiTools.BeginGroup(5);
                {
                    ...
                    {
                        t.allowSimulationStandalone = ETCGuiTools.Toggle("Allow Unity axes on standalone",
                            t.allowSimulationStandalone, true);
                ...
                ETCGuiTools.BeginGroup(5);
                {
                    ...
                    t.isTurnAndMove =
                        ETCGuiTools.Toggle("Turn & Move direction Action", t.isTurnAndMove, true, 220, true);
                    if (t.isTurnAndMove)
                    {
                ...
                ETCGuiTools.BeginGroup(5);
                {
                    ETCAxisInspector.AxisInspector(t.axisX, "Horizontal", ETCBase.ControlType.Joystick, t.isTurnAndMove,
                        unityAxes);
                }
                ETCGuiTools.EndGroup();
                ...
                ETCGuiTools.BeginGroup(5);
                {
                    ETCAxisInspector.AxisInspector(t.axisY, "Vertical", ETCBase.ControlType.Joystick, t.isTurnAndMove,
                        unityAxes);
                }
                ETCGuiTools.EndGroup();
            }
            ...
            ETCGuiTools.BeginGroup();
            {
                ...
                if (t.enableCamera)
                {
                    ...
                    ETCGuiTools.BeginGroup(5);
                    {
                        ...
                        {
                            t.cameraTransform = (Transform) EditorGUILayout.ObjectField("Camera", t.cameraTransform,
                    ...
                    {
                        t.cameraTargetMode =
                            (ETCJoystick.CameraTargetMode) EditorGUILayout.EnumPopup("Target mode", t.cameraTargetMode);
                        if (t.cameraTargetMode == ETCBase.CameraTargetMode.UserDefined)
                        {
                            t.cameraLookAt = (Transform) EditorGUILayout.ObjectField("Camera target", t.cameraLookAt,
                                typeof(Transform), true);
                        }
                    ...
                    ETCGuiTools.BeginGroup(5);
                    {
                        ...
                        switch (t.cameraMode)
                        {
                            ...
                            case ETCJoystick.CameraMode.SmoothFollow:
                                ...
                                t.followHeightDamping =
                                    EditorGUILayout.FloatField("Height damping", t.followHeightDamping);
                                t.followRotationDamping =
                                    EditorGUILayout.FloatField("Rotation dampping", t.followRotationDamping);
                                break;
                        }
                    }
                    ETCGuiTools.EndGroup();
        ...
        if (t.showSpriteInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                t.GetComponent<Image>().sprite = (Sprite) EditorGUILayout.ObjectField("Background",
                    t.GetComponent<Image>().sprite, typeof(Sprite), true, GUILayout.MinWidth(100));
                t.GetComponent<Image>().color =
                    EditorGUILayout.ColorField("", t.GetComponent<Image>().color, GUILayout.Width(50));
                ...
                ETCGuiTools.DrawTextureRectPreview(lastRect, spriteRect, t.GetComponent<Image>().sprite.texture,
                    Color.white);
                ...
                EditorGUILayout.BeginHorizontal();
                t.thumb.GetComponent<Image>().sprite = (Sprite) EditorGUILayout.ObjectField("Thumb",
                    t.thumb.GetComponent<Image>().sprite, typeof(Sprite), true, GUILayout.MinWidth(100));
                t.thumb.GetComponent<Image>().color =
                    EditorGUILayout.ColorField("", t.thumb.GetComponent<Image>().color, GUILayout.Width(50));
                EditorGUILayout.EndHorizontal();
                ...
                ETCGuiTools.DrawTextureRectPreview(lastRect, spriteRect, t.thumb.GetComponent<Image>().sprite.texture,
                    Color.white);
    ...
    private void TurnAndMove(ETCAxis X, ETCAxis Y, ETCJoystick j)
    {
        ...
        {
            X.directTransform =
                (Transform) EditorGUILayout.ObjectField("Direct action to", X.directTransform, typeof(Transform), true);
        }
