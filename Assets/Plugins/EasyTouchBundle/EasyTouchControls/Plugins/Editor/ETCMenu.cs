...
public static class ETCMenu
{
    ...
    static void AddJoystick()
    {
        ...
        GameObject joystick = new GameObject("New Joystick", typeof(ETCJoystick), typeof(RectTransform),
    ...
    {
        GameObject canvas = new GameObject("EasyTouchControlsCanvas", typeof(RectTransform), typeof(Canvas),
