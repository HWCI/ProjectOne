    ...
    public override void OnInspectorGUI()
    {
            ...
            ETCGuiTools.BeginGroup();
            {
                ...
                if (t.axis.showGeneralInspector)
                {
                    ETCGuiTools.BeginGroup(20);
                    {
                        ...
                        t.axis.isValueOverTime =
                            ETCGuiTools.Toggle("Value over the time", t.axis.isValueOverTime, true);
                        if (t.axis.isValueOverTime)
                        {
                            ETCGuiTools.BeginGroup(5);
                            {
                                t.axis.overTimeStep = EditorGUILayout.FloatField("Step", t.axis.overTimeStep);
                                t.axis.maxOverTimeValue =
                                    EditorGUILayout.FloatField("Max value", t.axis.maxOverTimeValue);
                            }
                            ETCGuiTools.EndGroup();
                        }
                ...
                if (t.axis.showDirectInspector)
                {
                    ETCGuiTools.BeginGroup(20);
                    {
                        ...
                        t.axis.autoLinkTagPlayer = EditorGUILayout.ToggleLeft("Auto link on tag",
                            t.axis.autoLinkTagPlayer, GUILayout.Width(200));
                        ...
                        {
                            t.axis.directTransform = (Transform) EditorGUILayout.ObjectField("Direct action to",
                                t.axis.directTransform, typeof(Transform), true);
                        }
                        ...
                        t.axis.directAction =
                            (ETCAxis.DirectAction) EditorGUILayout.EnumPopup("Action", t.axis.directAction);

                        if (t.axis.directAction != ETCAxis.DirectAction.Jump)
                        {
                            t.axis.axisInfluenced =
        ...
        if (t.showSpriteInspector)
        {
            ETCGuiTools.BeginGroup();
            {
                ...
                t.normalSprite = (Sprite) EditorGUILayout.ObjectField("Normal", t.normalSprite, typeof(Sprite), true,
                ...
                // Press state
                EditorGUILayout.BeginHorizontal();
                t.pressedSprite = (Sprite) EditorGUILayout.ObjectField("Pressed", t.pressedSprite, typeof(Sprite), true,
                    GUILayout.MinWidth(100));
