...
public abstract class ETCBase : MonoBehaviour
{
        ...
        switch (_anchor)
        {
            case RectAnchor.TopLeft:
                ...
                this.rectTransform().anchoredPosition = new Vector2(
                    this.rectTransform().sizeDelta.x / 2f + _anchorOffet.x,
                    -this.rectTransform().sizeDelta.y / 2f - _anchorOffet.y);
                break;
            case RectAnchor.TopCenter:
                this.rectTransform().anchorMin = new Vector2(0.5f, 1);
                this.rectTransform().anchorMax = new Vector2(0.5f, 1);
                this.rectTransform().anchoredPosition = new Vector2(_anchorOffet.x,
                    -this.rectTransform().sizeDelta.y / 2f - _anchorOffet.y);
                break;
            ...
            case RectAnchor.CenterLeft:
                ...
                this.rectTransform().anchoredPosition =
                    new Vector2(this.rectTransform().sizeDelta.x / 2f + _anchorOffet.x, _anchorOffet.y);
                break;
    ...
    protected void CameraSmoothFollow()
    {
        ...
        currentRotationAngle = Mathf.LerpAngle(currentRotationAngle, wantedRotationAngle,
            followRotationDamping * Time.deltaTime);
        ...
        if (enableWallDetection)
        {
            ...
            if (Physics.Linecast(
                new Vector3(cameraLookAt.position.x, cameraLookAt.position.y + 1f, cameraLookAt.position.z), newPos,
                out wallHit))
            {
