...
namespace HedgehogTeam.EasyTouch
{
    ...
    public class QuickSwipe : QuickBase
    {
        ...
        [SerializeField] public OnSwipeAction onSwipeAction;
        ...
        {
            if (gesture.touchCount == C_Finger &&
                ((gesture.pickedObject != gameObject && !allowSwipeStartOverMe) || allowSwipeStartOverMe))
            {
            ...
            switch (swipeDirection)
            {
                ...
                case SwipeDirection.Horizontal:
                    if (gesture.swipe == EasyTouch.SwipeDirection.Left ||
                        gesture.swipe == EasyTouch.SwipeDirection.Right)
                    {
