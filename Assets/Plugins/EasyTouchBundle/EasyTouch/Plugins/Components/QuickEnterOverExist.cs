...
namespace HedgehogTeam.EasyTouch
{
    ...
    public class QuickEnterOverExist : QuickBase
    {
        ...
        [SerializeField] public OnTouchEnter onTouchEnter;
        [SerializeField] public OnTouchOver onTouchOver;
        [SerializeField] public OnTouchExit onTouchExit;
        ...
        void On_TouchDown(Gesture gesture)
        {
            if (realType != GameObjectType.UI)
            {
                ...
                {
                    if (gesture.GetCurrentPickedObject() == gameObject &&
                        (!enablePickOverUI && gesture.GetCurrentFirstPickedUIElement() != null))
                    {
                        if (fingerOver[gesture.fingerIndex])
                        {
                            fingerOver[gesture.fingerIndex] = false;
