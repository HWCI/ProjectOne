...
namespace HedgehogTeam.EasyTouch
{
    ...
    public class QuickDrag : QuickBase
    {
        ...
        [SerializeField] public OnDragStart onDragStart;
        [SerializeField] public OnDrag onDrag;
        [SerializeField] public OnDragEnd onDragEnd;
            ...
            if (realType == GameObjectType.UI)
            {
                if (gesture.isOverGui)
                {
                    if ((gesture.pickedUIElement == gameObject ||
                         gesture.pickedUIElement.transform.IsChildOf(transform)) && fingerIndex == -1)
                    {
